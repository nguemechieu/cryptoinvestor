...
@Entity
@Table(name = "Account")
public class Account implements Serializable, ObservableList<Account> {
...
//    Unique identifier for account.
    ...
    public Account(@NotNull JSONObject account) {
        ...
        guaranteedStopLossOrderMode = account.getString(
        ...
        Order order = new Order(account.getJSONArray("orders"));
...
//    Denomination of the currency.
    ...
    @Override
    public void addListener(ListChangeListener<? super Account> listener) {

    }

    @Override
    public void removeListener(ListChangeListener<? super Account> listener) {

    }

    @Override
    public boolean addAll(Account... elements) {
        return false;
    }

    @Override
    public boolean setAll(Account... elements) {
        return false;
    }

    @Override
    public boolean setAll(Collection<? extends Account> col) {
        return false;
    }

    @Override
    public boolean removeAll(Account... elements) {
        return false;
    }

    @Override
    public boolean retainAll(Account... elements) {
        return false;
    }
    ...
    @Override
    public FilteredList<Account> filtered(Predicate<Account> predicate) {
        return ObservableList.super.filtered(predicate);
    }

    @Override
    public SortedList<Account> sorted(Comparator<Account> comparator) {
        return ObservableList.super.sorted(comparator);
    }

    @Override
    public SortedList<Account> sorted() {
        return ObservableList.super.sorted();
    }
    ...
    @Override
    public boolean removeIf(Predicate<? super Account> filter) {
    ...
    @Override
    public void replaceAll(UnaryOperator<Account> operator) {
        ObservableList.super.replaceAll(operator);
    }

    @Override
    public void sort(Comparator<? super Account> c) {
