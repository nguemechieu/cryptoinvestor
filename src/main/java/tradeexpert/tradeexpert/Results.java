...
import tradeexpert.tradeexpert.Viewport;
...
public class Results {
    ...
    public Results(String[] types, String compound_code, address_components address_component1, String formatted_address, @NotNull plus_code plus_code, String place_id, String location_type, Viewport viewport) {
        this.types = types;
