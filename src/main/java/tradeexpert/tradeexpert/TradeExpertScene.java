...
import tradeexpert.tradeexpert.BinanceUs.BinanceUs;
import tradeexpert.tradeexpert.Coinbase.Coinbase;
import tradeexpert.tradeexpert.oanda.OANDA_ACCESS_TOKEN;
import tradeexpert.tradeexpert.oanda.Oanda;
...
public class TradeExpertScene extends AnchorPane {
    private static final Logger logger = LoggerFactory.getLogger(TradeExpertScene.class);
...
logger.info("TradeExpertScene created");
    }
    ...
    private @NotNull HBox getPortFolio() {
        ...
        gridPortFolio.add(new Label(String.valueOf(Oanda.getFreeMargin())), 1, 6);
        gridPortFolio.add(new Label("Profit  "), 0, 7);
        gridPortFolio.add(new Label(String.valueOf(Oanda.getProfit())), 1, 7);
