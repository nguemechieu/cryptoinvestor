...
public class ChartColors {
    ...
    public static final Paint CANDLE_STROKE_COLOR = Color.BLACK;

    public static Paint BEAR_CANDLE_BORDER_COLOR = Color.TRANSPARENT;
    ...
    public static final Paint PLACE_HOLDER_FILL_COLOR = Color.TRANSPARENT;
