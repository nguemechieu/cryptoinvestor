package org.tradeexpert.tradeexpert.oanda;//package org.tradeexpert.tradeexpert.oanda;
//
...
//    private static String api_key = String.valueOf(OANDA_ACCESS_TOKEN.ACCESS_TOKEN);
...
//        OandaClient.symbol = symbol;
//        OandaClient.quantity = quantity;
//        OandaClient.price = price;
//        OandaClient.side = side;
...
//
//        @Override
//        public CompletableFuture<Optional<Object>> fetchCandleDataForInProgressCandle(String tradePair, Instant currentCandleStartedAt, long secondsIntoCurrentCandle, int secondsPerCandle) {
//
//            return null;
//        }
//
